...
var calc_constants = {
    ...
    ShowLogos: 1, // RECE default: hide upstream USC and ERDC logos
...
async function loadConfig() {
    try {
        ...
        console.log("Loading config path:", filePath, "run_example:", calc_constants.run_example);
