...
- The Design-mode colorbar scissor uses the same clamped screen-height calculation as the fragment shader so small LOD grids do not reserve an oversized bottom area.
